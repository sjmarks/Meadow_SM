...
#### Prev. Rock Creek Compile (July 2020)

```{r}
RC_compile_July2020 <- readr::read_csv(file = "RC_SM_July2020/compiled_RC_July2020.csv", 
...
compiled_RC_Aug2020 <- process_SM_data(path = "C:/Users/Simon/Desktop/Meadow_SM/RC_SM_Aug2020", 
                                        site = "RC", prev_compile = RC_compile_July2020, written_file_name = "compiled_RC_Aug2020.csv")


```

#### Prev. Compile Marian (July 2020)

```{r}
MM_compile_July2020 <- readr::read_csv(file = "Marian_SM_July2020/compiled_Marian_July2020.csv", 
                                       col_types = cols(Date = col_character(), .default = col_double())) %>% 
  dplyr::mutate(Date = lubridate::ymd_hms(Date))
```
...
```{r}
compiled_Marian_Aug2020 <- process_SM_data(path = "C:/Users/Simon/Desktop/Meadow_SM/Marian_SM_Aug2020", 
                                        site = "marian", prev_compile = MM_compile_July2020, written_file_name = "compiled_Marian_Aug2020.csv")
```

#### Control Meadow Soil Moisture Data

```{r}
Control_compile_July2020 <- readr::read_csv(file = "Control_SM_July2020/compiled_Control_July2020.csv", 
                                       col_types = cols(Date = col_character(), .default = col_double())) %>% 
  dplyr::mutate(Date = lubridate::ymd_hms(Date))
```

```{r}
compiled_Control_Aug2020 <- process_SM_data(path = "C:/Users/Simon/Desktop/Meadow_SM/Control_SM_Aug2020", 
                                        site = "control", prev_compile = Control_compile_July2020, written_file_name = "compiled_Control_Aug2020.csv")
```

#### Childs Meadow Soil Moisture Data

```{r}
Childs_compile_July2020 <- readr::read_csv(file = "Childs_SM_July2020/compiled_Childs_July2020.csv", 
                                       col_types = cols(Date = col_character(), .default = col_double())) %>% 
  dplyr::mutate(Date = lubridate::ymd_hms(Date))
```

```{r}
compiled_Childs_Aug2020 <- process_SM_data(path = "C:/Users/Simon/Desktop/Meadow_SM/Childs_SM_Aug2020", 
                                        site = "Childs", prev_compile = Childs_compile_July2020, written_file_name = "compiled_Childs_Aug2020.csv")
```
