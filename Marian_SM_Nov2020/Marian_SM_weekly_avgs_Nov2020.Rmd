---
title: "Marian_SM_weekly_avgs_Nov2020"
author: "Simon Marks"
date: "12/3/2020"
...
Marian_SM_Nov2020 <- readr::read_csv("Marian_SM_Nov2020/compiled_Marian_Nov2020.csv", col_types = cols(Date = col_character(), .default = col_double())) %>% 
...
* Note that 1 meter depth for MMSM1 is stuck at approx. 0.7 VWC starting at week of 2019-08-02, will need to ignore this later

**First week is week of 2019-04-26, last week is week of 2020-11-13*

```{r}

weekly_Marian_SM_toNov2020 <- temp_agg_meadow_dat(Marian_SM_good_data_Nov2020, interval = "30 min", start_day_of_week = 6, data.thresh = 50)

# write out to CSV

weekly_Marian_SM_toNov2020 %>% 
    mutate(date = as.character(date)) %>%
    rename(Date = date) %>%
    readr::write_csv(path = "Marian_SM_Nov2020/weekly_SM_Marian_Nov2020.csv")
