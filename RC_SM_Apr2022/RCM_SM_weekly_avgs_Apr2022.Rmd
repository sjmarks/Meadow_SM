---
title: "RCM_SM_weekly_avgs_Apr2022"
author: "Joe Murphy"
date: "05/04/2022"
...
## Latest RCM Compilation Data (Apr 2022)

```{r}

# Rock Creek, for function testing purposes

RC_SM_Apr2022 <- readr::read_csv("compiled_ver2_RC_Apr2022.csv", col_types = cols(Date = col_character(), .default = col_double())) %>% 
...
RC_SM_good_data_Apr2022 <- RC_SM_Apr2022 %>%
...
weekly_RC_SM_toApr2022<- temp_agg_meadow_dat(RC_SM_good_data_Apr2022, interval = "30 min", start_day_of_week = 7)

# write out to CSV

weekly_RC_SM_toApr2022 %>% 
    mutate(date = as.character(date)) %>%
    rename(Date = date) %>%
    readr::write_csv(path = "weekly_SM_RC_Apr2022.csv")
